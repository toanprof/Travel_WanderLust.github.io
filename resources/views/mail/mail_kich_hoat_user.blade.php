                                                        ...
                                                        <table
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" bgcolor="#ffffff"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Chào mừng,
                                                                        <strong>{{ $ho_va_ten }}</strong>&nbsp;đã đến
                                                                        với website của chúng tôi. Để kích hoạt tài
                                                                ...
                                                                <td align="center"
                                                                    ...
                                                                    <span class="es-button-border"
                                                                        style="border-style:solid;border-color:#FFA73B;background:1px;border-width:1px;display:inline-block;border-radius:2px;width:auto"><a
                                                                            href="{{ env('APP_URL') }}/user/active/{{ $hash }}"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <a target="_blank"
                                                                        href="{{ env('APP_URL') }}/user/active/{{ $hash }}"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#FFA73B;font-size:18px">{{ env('APP_URL') }}/user/active/{{ $hash }}</a>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <em><strong>andreapirlo257@gmail.com<br></strong></em>Đây
